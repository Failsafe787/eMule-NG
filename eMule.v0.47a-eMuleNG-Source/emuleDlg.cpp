...
#endif
*/
	if (WSAAsyncGetHostByName(m_hWnd, UM_VERSIONCHECK_RESPONSE, "emule-project.dyndns.org", m_acVCDNSBuffer, sizeof(m_acVCDNSBuffer)) == 0) {
//<<< UseNeXT Support
...
//>>> UseNeXT Support
			...
			theUrl.Format(_T("/version_check.php?version=%i"),theApp.m_uCurVersionCheck,thePrefs.GetLanguageID()); //>>> UseNeXT Support
			theUrl = thePrefs.GetVersionCheckBaseURL()+theUrl;
//<<< UseNeXT Support
...
//>>> UseNeXT Support
			...
			theUrl.Format( thePrefs.GetVersionCheckBaseURL() + CString(_T("/version_check.php?version=%i")),theApp.m_uCurVersionCheck);
//<<< UseNeXT Support
			ShellExecute(NULL, NULL, theUrl, NULL, thePrefs.GetAppDir(), SW_SHOWDEFAULT);
			break;
		}
...
//>>> UseNeXT Support
							//theUrl.Format(_T("/en/version_check.php?version=%i&language=%i"),theApp.m_uCurVersionCheck,thePrefs.GetLanguageID());
							//theUrl = thePrefs.GetVersionCheckBaseURL()+theUrl;
							theUrl.Format(_T("/version_check.php?version=%i"),theApp.m_uCurVersionCheck);
							theUrl = thePrefs.GetVersionCheckBaseURL()+theUrl;
//<<< UseNeXT Support
							ShellExecute(NULL, NULL, theUrl, NULL, thePrefs.GetAppDir(), SW_SHOWDEFAULT);
						}
...
//>>> UseNeXT Support
			...
			CString strUrl = thePrefs.GetHomepageBaseURL();
//<<< UseNeXT Support			
