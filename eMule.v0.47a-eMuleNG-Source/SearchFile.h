...
public:
	...
	CSearchFile(CString filename, LPCTSTR filetype, uint32 filesize, uint32 searchID, CString link); //>>> UseNeXT Support
	virtual ~CSearchFile();
...
//>>> UseNeXT Support
private:
	bool		m_bIsUseNeXTFile;
	CString		m_sUseNeXTLink;
public:
	bool		IsUseNeXTFile() const	{return m_bIsUseNeXTFile;}
	CString		GetUseNeXTLink() const	{return m_sUseNeXTLink;}
//<<< UseNeXT Support
};
