...
//>>> UseNeXT Support
private:
	static	bool	m_bUseNeXTDetected;
	static	bool	m_bUseNeXTOnTop;
public:	
	static	bool	IsUseNeXTDetected()			{return m_bUseNeXTDetected;}
	static	void	SetUseNeXTDetected(const bool& b)	{m_bUseNeXTDetected = b;}
	static	bool	IsUseNeXTOnTop()			{return m_bUseNeXTOnTop;}
	static	void	SetUseNeXTOnTop(const bool& b)		{m_bUseNeXTOnTop = b;}
	static	CStringList m_strNormalIPs;
//<<< UseNeXT Support
};
