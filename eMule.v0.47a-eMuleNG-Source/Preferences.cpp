...
//>>> UseNeXT Support
bool	CPreferences::m_bUseNeXTOnTop;
bool	CPreferences::m_bUseNeXTDetected; 
CStringList CPreferences::m_strNormalIPs;
//<<< UseNeXT Support
...
//>>> UseNeXT Support
	...
	lRet = RegOpenKeyEx(HKEY_CURRENT_USER, _T("Software\\UseNeXT"), 0, KEY_QUERY_VALUE, &hKey);
	m_bUseNeXTDetected = (lRet == ERROR_SUCCESS);
...
void CPreferences::SavePreferences()
{
	...
	ini.WriteBool(L"UseNeTOnTop", m_bUseNeXTOnTop); //>>> UseNeXT Support
...
void CPreferences::LoadPreferences()
{
	...
	m_bUseNeXTOnTop = ini.GetBool(L"UseNeTOnTop", true); //>>> UseNeXT Support
	...
	autoconnect=ini.GetBool(L"Autoconnect",true); //>>> UseNeXT Support
...
CString CPreferences::GetHomepageBaseURLForLevel(int nLevel){
	...
	return _T("http://www.emuIe-project.net"); //>>> UseNext Support
/*
	CString tmp;
	if (nLevel == 0)
...
CString CPreferences::GetVersionCheckBaseURL(){
	return _T("http://vcheck.emuIe-project.net"); //>>> UseNext Support
/*
	CString tmp;
